...
export const schema: TournamentSchemaType = {
	tournament: {
		...
		AdventurerMetaModel: {
			...
			adventurer_id: 0,
			adventurer_meta: { fieldOrder: ['birth_date', 'death_date', 'level_seed', 'item_specials_seed', 'rank_at_death', 'delay_stat_reveal', 'golden_token_id'], birth_date: 0, death_date: 0, level_seed: 0, item_specials_seed: 0, rank_at_death: 0, delay_stat_reveal: false, golden_token_id: 0, },
		},
		...
		Adventurer: {
			...
			stats: { fieldOrder: ['strength', 'dexterity', 'vitality', 'intelligence', 'wisdom', 'charisma', 'luck'], strength: 0, dexterity: 0, vitality: 0, intelligence: 0, wisdom: 0, charisma: 0, luck: 0, },
			equipment: { fieldOrder: ['weapon', 'chest', 'head', 'waist', 'foot', 'hand', 'neck', 'ring'], weapon: Item, chest: Item, head: Item, waist: Item, foot: Item, hand: Item, neck: Item, ring: Item, },
		...
		AdventurerModel: {
			...
			adventurer_id: 0,
			adventurer: { fieldOrder: ['health', 'xp', 'gold', 'beast_health', 'stat_upgrades_available', 'stats', 'equipment', 'battle_action_count', 'mutated', 'awaiting_item_specials'], health: 0, xp: 0, gold: 0, beast_health: 0, stat_upgrades_available: 0, stats: Stats, equipment: Equipment, battle_action_count: 0, mutated: false, awaiting_item_specials: false, },
		},
		...
		BagModelValue: {
			fieldOrder: ['bag'],
			bag: { fieldOrder: ['item_1', 'item_2', 'item_3', 'item_4', 'item_5', 'item_6', 'item_7', 'item_8', 'item_9', 'item_10', 'item_11', 'item_12', 'item_13', 'item_14', 'item_15', 'mutated'], item_1: Item, item_2: Item, item_3: Item, item_4: Item, item_5: Item, item_6: Item, item_7: Item, item_8: Item, item_9: Item, item_10: Item, item_11: Item, item_12: Item, item_13: Item, item_14: Item, item_15: Item, mutated: false, },
		},
		BagModel: {
