...
export async function setupWorld(provider: DojoProvider) {
	...
	const tournament_mock_tournamentPrizeKeys = async (tournamentId: BigNumberish) => {
		try {
			return await provider.call("tournament", {
				contractName: "tournament_mock",
	...
	const tournament_mock_registerTokens = async (snAccount: Account | AccountInterface, tokens: Array<Token>) => {
		try {
			return await provider.execute(
				snAccount,
				{
	...
	const tournament_mock_createTournament = async (snAccount: Account | AccountInterface, name: BigNumberish, description: string, startTime: BigNumberish, endTime: BigNumberish, submissionPeriod: BigNumberish, winnersCount: BigNumberish, gatedType: models.CairoOption<GatedType>, entryPremium: models.CairoOption<GatedType>) => {
		try {
			return await provider.execute(
				snAccount,
				{
	...
	const tournament_mock_enterTournament = async (snAccount: Account | AccountInterface, tournamentId: BigNumberish, gatedSubmissionType: models.CairoOption<GatedType>) => {
		try {
			return await provider.execute(
				snAccount,
				{
	...
	const tournament_mock_startTournament = async (snAccount: Account | AccountInterface, tournamentId: BigNumberish, startAll: boolean, startCount: models.CairoOption<GatedType>) => {
		try {
			return await provider.execute(
				snAccount,
				{
	...
	const tournament_mock_addPrize = async (snAccount: Account | AccountInterface, tournamentId: BigNumberish, token: string, tokenDataType: models.TokenDataTypeEnum, position: BigNumberish) => {
		try {
			return await provider.execute(
				snAccount,
				{
	...
	const tournament_mock_initializer = async (snAccount: Account | AccountInterface, ethAddress: string, lordsAddress: string, lootSurvivorAddress: string, oracleAddress: string, safeMode: boolean, testMode: boolean) => {
		try {
			return await provider.execute(
				snAccount,
				{
					...
					calldata: [ethAddress, lordsAddress, lootSurvivorAddress, oracleAddress, safeMode, testMode],
				},
				"tournament",
			);
		} catch (error) {
	...
	const eth_mock_transfer = async (snAccount: Account | AccountInterface, recipient: string, amount: BigNumberish) => {
		try {
			return await provider.execute(
				snAccount,
				{
	...
	const eth_mock_transferFrom = async (snAccount: Account | AccountInterface, sender: string, recipient: string, amount: BigNumberish) => {
		try {
			return await provider.execute(
				snAccount,
				{
	...
	const eth_mock_approve = async (snAccount: Account | AccountInterface, spender: string, amount: BigNumberish) => {
		try {
			return await provider.execute(
				snAccount,
				{
	...
	const eth_mock_mint = async (snAccount: Account | AccountInterface, recipient: string, amount: BigNumberish) => {
		try {
			return await provider.execute(
				snAccount,
				{
	...
	const loot_survivor_mock_setAdventurer = async (snAccount: Account | AccountInterface, adventurerId: BigNumberish, adventurer: models.InputAdventurer) => {
		try {
			return await provider.execute(
				snAccount,
				{
	...
	const loot_survivor_mock_setAdventurerMeta = async (snAccount: Account | AccountInterface, adventurerId: BigNumberish, adventurerMeta: models.InputAdventurerMetadata) => {
		try {
			return await provider.execute(
				snAccount,
				{
	...
	const loot_survivor_mock_setBag = async (snAccount: Account | AccountInterface, adventurerId: BigNumberish, bag: models.InputBag) => {
		try {
			return await provider.execute(
				snAccount,
				{
	...
	const loot_survivor_mock_safeTransferFrom = async (snAccount: Account | AccountInterface, from: string, to: string, tokenId: BigNumberish, data: Array<BigNumberish>) => {
		try {
			return await provider.execute(
				snAccount,
				{
	...
	const loot_survivor_mock_transferFrom = async (snAccount: Account | AccountInterface, from: string, to: string, tokenId: BigNumberish) => {
		try {
			return await provider.execute(
				snAccount,
				{
	...
	const loot_survivor_mock_approve = async (snAccount: Account | AccountInterface, to: string, tokenId: BigNumberish) => {
		try {
			return await provider.execute(
				snAccount,
				{
