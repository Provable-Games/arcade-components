...
use tournament::ls15_components::models::{
    loot_survivor::{
        AdventurerMetadata, m_AdventurerModel, AdventurerModel, m_AdventurerMetaModel,
        AdventurerMetaModel, m_BagModel, BagModel, m_GameCountModel, GameCountModel, m_Contracts,
        Contracts
    },
    tournament::{
        m_TournamentModel, TournamentModel, m_TournamentEntryModel, TournamentEntryModel,
        m_TournamentEntryAddressesModel, TournamentEntryAddressesModel, m_TournamentStartIdsModel,
        TournamentStartIdsModel, m_TournamentEntriesModel, TournamentEntriesModel,
        m_TournamentScoresModel, TournamentScoresModel, m_TournamentTotalsModel,
        TournamentTotalsModel, m_TournamentPrizeKeysModel, TournamentPrizeKeysModel, m_PrizesModel,
        PrizesModel, m_TokenModel, TokenModel, m_TournamentContracts, TournamentContracts,
        ERC20Data, ERC721Data, Token, Premium, GatedToken, EntryCriteria, TokenDataType, GatedType,
...
//     let (_world, mut tournament, _loot_survivor, _pragma, _eth, _lords, _erc20, _erc721) =
//     setup();
...
//     );
//     assert(tournament_data.start_time == TEST_START_TIME().into(), 'Invalid tournament start
//     time');
...
//     let (_world, mut tournament, mut loot_survivor, _pragma, mut eth, mut lords, _erc20,
//     _erc721,) =
//         setup();
...
//     assert(
//         lords.balance_of(loot_survivor.contract_address) == 50000000000000000000, 'Invalid
//         balance'
//     );
...
//     assert(lords.balance_of(OWNER()) == STARTING_BALANCE - 50000000000000000000, 'Invalid
//     balance');
...
//     let tournament_data = tournament.tournament(tournament_id);
//     assert(tournament_data.entry_premium == Option::Some(entry_premium), 'Invalid entry
//     premium');
...
//     let (
//         _world, mut tournament, _loot_survivor, _pragma, mut eth, mut lords, mut erc20, mut
//         erc721,
//     ) =
//         setup();
