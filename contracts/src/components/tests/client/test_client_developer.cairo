...
use ls::tests::constants::{
    ...
    NEW_GITHUB_USERNAME, NEW_TELEGRAM_HANDLE, NEW_X_HANDLE
};
use ls::tests::utils;
...
fn STATE() -> (IWorldDispatcher, client_developer_mock::ContractState) {
    let world = spawn_test_world(
        array![client_developer_model::TEST_CLASS_HASH, erc_721_balance_model::TEST_CLASS_HASH]
    );
...
// TODO: Add tests for setting for developers without nft
// TODO: Add transfers
